...
def view_guest():
    ...
    if len(records) == 0:
        ...
        for data in records:
            print("guest_id :", data[0])
            print("full_name:", data[1])
            print("gender   :", data[2])
            print("phone    :", data[3])
            print("email    :", data[4])
            print("address  :", data[5])
            print("id_proof :", data[6])
            print("Proof No :", data[7])
            print("----------------------------")
...
def update_guest():
    ...
    id_proof = input("New ID Proof Type: ")
    ...
    cursor.execute(query,
    (full_name, gender,phone, email, address, id_proof, proof_number, guest_id))
